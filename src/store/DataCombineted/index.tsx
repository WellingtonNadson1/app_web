...
type ActionsProps = {
  ...
  setEcontro: (encontro: Encontros) => void;
...
export const useCombinetedStore = create(persist<CombinedDataStore>(
  (set) => ({
    state: {
      supervisoes: [],
      escolas: [],
    ...
    actions: {
      ...
      setEcontro: (encontro) =>
        set((state) => ({
          ...
          state: {
            ...state.state,
            econtros: [...state.state.encontros, encontro]
          }
        })),
      ...
      setSituacoesNoReino: (situacaoreino) =>
        set((state) => ({
          ...
          state: {
            ...state.state,
            situacoesNoReino: [...state.state.situacoesNoReino, situacaoreino]
          }
        })),
