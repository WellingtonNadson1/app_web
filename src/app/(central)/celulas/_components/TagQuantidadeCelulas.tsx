...
interface TagQuantidadeCelulasProps
...
export const TagQuantidadeCelulas: React.FC<TagQuantidadeCelulasProps> = ({
  cor = 'yellow',
  nomeSupervisao,
  data,
  ...props
  ...
  return (
    ...
    >
      <p className="flex items-center justify-between">
        ...
        <span
          className={cn(
            `px-1 py-1 ml-2 text-white rounded-md bg-yellow-500`,
            `bg-${cor}-500`,
          )}
        >
