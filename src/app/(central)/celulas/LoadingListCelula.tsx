          ...
          <table className="w-full border-separate table-auto border-spacing-y-3">
            ...
            <thead>
              <tr className="text-base font-bold ">
                <th className="py-2 text-gray-800 text-start">Ord.</th>
                  ...
                  <tr key={index} className="py-8 border-b border-gray-200">
                    ...
                    <td>
                      <div className="flex items-center justify-center w-full gap-2 mx-auto text-center">
                        <button className="'z-10 rounded-md bg-green-600 px-4 py-2 text-sm font-medium text-white hover:bg-green-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-700'">
                          Acessar
                        </button>
                        <button className="'z-10 rounded-md bg-blue-950 px-4 py-2 text-sm font-medium text-white hover:bg-blue-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-700'">
                          Editar
                        </button>
                      </div>
                    </td>
