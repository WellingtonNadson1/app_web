    ...
    cell: ({ row }) => {
      ...
      return (
        <div className="flex w-full items-center justify-start ">
          <div>
            <HouseLine weight="light" color="#555353" size={23} />
          </div>
        ...
        <>
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <UpdateDataOcorreCelula
                id={celula.id}
                date_que_ocorre={celula.date_que_ocorre}
                lider={celula.lider}
                membros={celula.membros}
                nome={celula.nome}
                supervisao={celula.supervisao}
                key={celula.id}
              />
