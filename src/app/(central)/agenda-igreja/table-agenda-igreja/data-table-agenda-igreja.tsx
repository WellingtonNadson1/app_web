...
import { TagQuantidadeCelulas } from '../../celulas/_components/TagQuantidadeCelulas'
...
export function DataTableAgendaIgreja<TData, TValue>({
  columns,
  data,
  ...
  return (
    <div className="px-6 py-4 rounded-xl bg-white">
      ...
      <div className="flex items-center  justify-between py-4">
        <Input
          placeholder="🔍 Filtrar pelo evento..."
          value={globalFilter ?? ''}
          onChange={(event) => {
