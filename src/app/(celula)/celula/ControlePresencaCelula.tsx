...
export default function ControlePresencaCelula({
  ...
  const URLControlePresenca = `https://${hostname}/presencamembros`
          ...
          <div className="w-full rounded-md px-1 py-2">
            ...
            <div className="w-full border-separate border-spacing-y-6">
              <div className="grid grid-cols-3 text-base font-bold sm:grid-cols-5">
                ...
                <div className="hidden border-b-2 border-orange-300 py-2 text-gray-800 sm:block">
                  Status
                </div>
                <div className="hidden border-b-2 border-indigo-300 py-2 text-gray-800 sm:block">
                  Cargo
                </div>
                <div className="border-b-2 border-green-300 py-2 text-gray-800">
                  P
                </div>
                <div className="border-b-2 border-red-300 py-2 text-gray-800">
                  F
                </div>
              </div>
