...
const createReuniaoCelula = async (dataSend: reuniaoCelulaData2): Promise<{ status: string; celula: string; data_reuniao: string; presencas_membros_reuniao_celula: string; id?: string | undefined }[]> => {
