...
export default function ControlePresenceSupervisorSecond({
  ...
  const { data: PresenceExistRegisteredSupervisorSecond, isLoading, isSuccess: isSuccessGetPresence, error } = useQuery({
    queryKey: ['presenceExistRegisteredSupervisorSecond'],
    queryFn: getPresenceRegistered,
  })

  if (isSuccessGetPresence) {
    console.log('PresenceExistRegisteredSupervisorSecond', PresenceExistRegisteredSupervisorSecond)
  }
  ...
  const { mutateAsync: createPresencaCultoSupervisorFn, isPending: isPendingCreateSecondPresenceSupervisor, isSuccess } = useMutation({
    mutationFn: createPresencaCultoSupervisorFunction,
    onError: (err, newMember, context) => {
      queryClient.invalidateQueries({ queryKey: ['presenceExistRegisteredSupervisorSecond'] })
