...
} from '../components/listMembersCelulaDiscipulado/schema';
import Scheleton from '../components/listMembersCelulaDiscipulado/scheleton';
...
export default function ListMembersCelulaDiscipulado() {
  ...
  const { data: celulaData, isLoading: loadingDataCelula } =
    useQuery<CelulaData>({
      queryKey: ['celulaData'],
  ...
  const cell_id = celulaData?.id as string;
  ...
  console.log('celulaData', celulaData);
    ...
    <>
      <div className="relative w-full px-1 py-2 mx-auto">
        <div className="relative w-full mx-auto">
          <HeaderCelulaDiscipulados headerCelula={celulaData?.nome} />
        </div>
      </div>
      <div className="relative w-full px-2 -my-1">
            ...
            <div className="w-full px-1 py-2 rounded-md">
              ...
              <Pagination
                ...
                totalPages={Math.ceil(
                  (celulaData?.membros?.length || 0) / itemsPerPage,
                )}
