'use client';
import { Member } from '@/app/(private)/(central)/central/novo-membro/schema';
...
function UpdateSupervisorDisicipulado(props: UpdateSupervisorProps) {
  ...
  const UpdateDiscipuladorFunction = async (
    ...
    try {
      ...
      toast('🙌🏻 Disicipulador Atualizado!');
      return data;
    } catch (error) {
      toast('⛔ Error na Atualização!');
                      ...
                      <div className="sm:col-span-2">
                        ...
                        <div className="mt-3 pl-2">
                          <input
                            type="text"
                            name="membro"
                            value={props?.member?.user_discipulos?.first_name}
                            id="membro"
                            disabled
