                                  ...
                                  <Disclosure.Panel className="w-full px-2 pt-4 pb-2 text-sm text-gray-500 sm:flex sm:flex-col">
                                    <div className='flex items-center justify-between mb-3'>
                                      ...
                                      <div className="flex items-center justify-start">
                                        <h2 className="ml-4">{user?.discipulador_usuario_discipulador_usuario_usuario_idTouser[0]?.user_discipulador_usuario_discipulador_idTouser?.first_name || 'Sem Registro'}</h2>
                                      </div>
                                    </div>
                                  ...
                                  <Disclosure.Panel className="w-full px-2 pb-2 text-sm text-gray-500 sm:pt-2">
                                    ...
                                    <form action="" method="post">
                                      <input type="date"
                                        ...
                                        className="block w-full rounded-md border-0 py-1.5 mb-2 text-slate-700 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6" />
                                      <button className='mx-auto flex w-full items-center justify-center rounded-md bg-[#014874] px-3 py-1.5 mb-6 sm:mb-2 text-sm font-semibold leading-7 text-white shadow-sm duration-100 hover:bg-[#1D70B6] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#014874]' type="submit">Registrar</button>
                                    </form>
                                  </Disclosure.Panel>
                                </>
                              )}
