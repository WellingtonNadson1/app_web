        ...
        <div className="relative mx-auto w-full py-2">
          <div className="w-full rounded-lg bg-white p-4 shadow-md">
            <div className='flex items-center justify-between sm:justify-start gap-3'>
              ...
              <div className='items-center justify-center rounded-md px-3 py-2 text-center text-xs font-medium ring-1 ring-inset bg-blue-50  text-sky-700 ring-blue-600/20'>
                <p>Total <span className='text-white ml-2 rounded-md px-2 py-1 bg-sky-700'>{data?.length}</span></p>
              </div>
            </div>
            <div className="p-2">
