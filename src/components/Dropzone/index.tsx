                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                  <div className="pb-3">
                          ...
                          {isDragReject ? (
                            <label className="flex flex-col rounded-lg border-2 border-dashed w-full h-60 p-10 border-red-400 text-center">
                              <div className="h-full w-full text-center flex flex-col items-center justify-center">
                                ...
                                <p className="pointer-none text-gray-500 ">
                                  <span className="text-sm">Arquivo</span> não
                                  suportado
                                </p>
                              </div>
                            </label>
                            ...
                            >
                              <div className="h-full w-full text-center flex flex-col items-center justify-center">
                                ...
                                {isDragActive ? (
                                  <p className="pointer-none text-gray-500 ">
                                    <span className="text-sm">Solte</span> o
                                    arquivo aqui
                                  </p>
                                ) : (
                                  <p className="pointer-none text-gray-500 ">
                    ...
                    <div>
                      <button
                        type="submit"
                        className="my-5 w-full flex justify-center bg-blue-500 text-gray-100 p-4 rounded-md tracking-wide font-semibold  focus:outline-none focus:shadow-outline hover:bg-blue-600 shadow-lg cursor-pointer transition ease-in duration-300"
                      >
                        Upload
                      </button>
                    </div>
